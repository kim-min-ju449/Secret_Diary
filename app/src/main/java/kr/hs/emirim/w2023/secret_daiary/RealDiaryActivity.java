...
public class RealDiaryActivity extends AppCompatActivity {
    Button btn;
...
//                String text = intent.getStringExtra("TextIn");
                intent.putExtra("content", mEdit.getText().toString());
...
//                        AlertDialog.Builder builder = new AlertDialog.Builder(RealDiaryActivity.this);
//                        builder.setTitle("삭제");
